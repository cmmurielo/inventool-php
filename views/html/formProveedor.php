<div class="contenido">
    ...
    <div class="botones">
        <button class="" onclick="window.location.href = '/listaProveedores.html'">
    ...
    <div class="buscar">
        <p>
            Buscar proveedor:
            <span>
                <input type="text" name="buscar" placeholder="Documento, Nombre..." /></span>
        </p>
    </div>
    ...
    <form class="grid-form">
        ...
        <input type="number" name="documento" class="input1" />

        <label for="tipoDocumento" class="label2">Tipo documento:</label>
        <select name="tipoDocumento" class="tipoDocumento input-col-4">
        ...
        <select name="tipoPersona" class="input1">
