<head>
    <link rel="stylesheet" href="vista/css/clientes.css" />
    <link rel="stylesheet" href="vista/css/formCliente.css" />
    <link rel="stylesheet" href="vista/css/modalCliente.css" />
</head>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editModalLabel">Eliminar cliente</h5>
...
<script>
    function selectCliente(document_id) {
        ...
        $.post("vista/html/includes/getCliente.php", {
            ...
            $("#edit-form [name='tipoDpcumento']").val(response[0].tipoDpcumento);
