...
CREATE TABLE `clientes` (
  ...
  UNIQUE KEY `documento_UNIQUE` (`cliente_documento`),
  KEY `fk_cliente_municipio_idx` (`municipio_id`),
  CONSTRAINT `fk_cliente_municipio` FOREIGN KEY (`municipio_id`) REFERENCES `municipios` (`municipio_id`)
...
INSERT INTO `clientes` VALUES (2213,'CC','QE','WER','QWE','MAIL4@MAIL',123,'231'),(23123,'CC','ASD','ADASD','23123','MAIL@MAIL',30,'WQEQWE'),(63545,'CC','ASDAS','QWSDASD','523432434','MAIL3@MAIL.COM',30,'WERWER'),(221334,'CC','QE','WER','QWE','MAIL4@MAIL',98,'231'),(1234123,'CC','LUISA FERNANDA','BUCURU','234234','MAIL@MAIL',30,'WRWER'),(2213343,'CC','QE','WER','QWE','MAIL4@MAIL',30,'231'),(6354534,'CC','ASDAS','QWSDASD','523432434','MAIL3@MAIL.COM',61,'WERWER'),(7756756,'CC','ASDT4FG','5GHFDGDFG','6313456','MAIL2@MAIL',20,'45656DSFSEFSD'),(22133432,'CC','QE','WER','QWE','MAIL4@MAIL',1,'231'),(23123213,'CC','ASDAS','ASDASD','4234234','MAIL@MAIL',251,'QWEQWE'),(1053812639,'CC','CARLOS MARIO','MURIEL GALVIS','3117766871','cmmurielo@mail.com',282,'MZ D CASA 8, LA SOLEDAD');
...
CREATE TABLE `facturas` (
  ...
  CONSTRAINT `fk_facturas_clientes1` FOREIGN KEY (`cliente_documento`) REFERENCES `clientes` (`cliente_documento`),
...
CREATE TABLE `municipios` (
  ...
  CONSTRAINT `fk_departamento_municiopio` FOREIGN KEY (`departamento_id`) REFERENCES `departamentos` (`departamento_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
-- Dump completed on 2022-06-15 22:16:12
